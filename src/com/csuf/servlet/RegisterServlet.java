		...
		if (errorMsg != null) {
			...
			try {
				ps = con.prepareStatement(
						"insert into user(firstname,lastname,password,email,dob,gender,bloodgroup,middlename,phone,address,city,state,zip,isdonor,country) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				...
				// message +="Patient Address:<b>"
				// +rs.getString("currentaddress")+ "</b><br><br>";
